<template>
      ...
      <form @submit.prevent="uploadFiles">
        <div>
          ...
          <input
            ...
            id="fileName"
            v-model="fileName"
            placeholder="Ange datasetets namn"
          />
        </div>
        <div>
        ...
        <div>
          <label>
            Vill du ladda upp en Infofil eller fylla i informationen själv?
          </label>
          <div class="option-toggle">
            <label>
              <input
                type="radio"
                v-model="useCustomInfo"
                :value="false"
              />
              Ladda upp Infofil
            </label>
        ...
        <button
          type="submit"
          :disabled="!fileName || !dataFile || (!useCustomInfo && !infoFile) || (useCustomInfo && (!infoData.labels || !infoData.description))"
        >
          Ladda upp filer
        </button>
      </form>
  ...
  export default {
    ...
    methods: {
      ...
      async uploadFiles() {
        if (!this.fileName || !this.dataFile || (!this.useCustomInfo && !this.infoFile) || 
